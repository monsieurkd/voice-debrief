 ...
 * concise, match depth) — every promptAddon says so explicitly.
 *
...
export const PERSONAS = {
  warm: {
    ...
    promptAddon:
      'Tone: gentle and grounding. Reflect feeling before facts. Comfort with presence, not solutions. Unhurried. These adapt your tone — the rules above always win.',
  },
  friend: {
    id: 'friend',
    ...
    promptAddon:
      'Tone: easygoing close friend. Casual, natural everyday language; light humor is welcome. Still listen first — never make it about you. These adapt your tone — the rules above always win.',
  },
  coach: {
    id: 'coach',
    label: 'Sharp coach',
    ...
    promptAddon:
      'Tone: sharp, encouraging coach. Be direct and concrete; name patterns you hear; nudge toward one small next step. No lecturing, no tough-love theatrics. These adapt your tone — the rules above always win.',
  },
} as const
...
export function isPersonaId(value: unknown): value is PersonaId {
  // Object.hasOwn, not `in` — `in` would accept prototype keys like 'toString'.
